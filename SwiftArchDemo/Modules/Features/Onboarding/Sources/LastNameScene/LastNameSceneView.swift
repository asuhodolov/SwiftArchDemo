...
@MainActor
protocol LastNameSceneViewInput: AnyObject {
    func setName(_ name: String?)
}

@MainActor
protocol LastNameSceneViewOutput: AnyObject {
    func viewDidLoad()
    func userDidUpdateName(_ name: String?)
    func userDidConfirmInput()
}

final class LastNameSceneView: UIViewController, ModuleHolderProtocol {
    var retainedModuleElements = [AnyObject]()

    weak var presenter: LastNameSceneViewOutput?
    ...
    private lazy var textField: UITextField = {
        ...
        textField.placeholder = String(
            localized: "onboaring_lastName_placeholder",
    ...
    private func prepareView() {
        title = String(
            localized: "onboaring_lastName_navigationTitle",
...
extension LastNameSceneView: LastNameSceneViewInput {
    func setName(_ name: String?) {
        textField.text = name
    }
}
